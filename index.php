...
?>
      ...
      <link rel="stylesheet" type="text/css" href="assets/headd.css">
			<link rel="stylesheet" type="text/css" href="css/default.css?NOx" />
		<link rel="stylesheet" type="text/css" href="css/component.css?nos" />
...
<div class='application'>
  <div id='about' ><h1 style="  text-shadow: 0 1px 0 #ccc,
               0 2px 0 #c9c9c9,
               0 3px 0 #bbb,
               0 4px 0 #b9b9b9,
               0 5px 0 #aaa,
  ...
  <h1> Contact Us </h1>
    <ul id="contact-form-body" class="flex-outer" style="display:inline">
      <li>
        ...
        <input type="text" name="contact-form-name" placeholder="Enter your name here">
      </li>
      <li>
        <label for="contact-form-email">Email</label>
        <input type="email" name="contact-form-email" placeholder="Enter your email here">
      </li>
      <li>
        <label for="contact-form-phone">Phone</label>
        <input type="tel" name="contact-form-phone" placeholder="Enter your phone here">
      </li>
      <li>
        <label for="contact-form-message">Message</label>
        <textarea rows="6" name="contact-form-message" placeholder="Enter your message here"></textarea>
      </li>
...
<h1 style="font-size: 22px"><i class="fa fa-quote-left" aria-hidden="true" ></i></h1>
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="carousel slide" data-ride="carousel" id="quote-carousel">
				<ol class="carousel-indicators hidden-xs" id="car-ind">
            ...
            <div class="formstl">
               ...
               <div  class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <form  action="#about" method="post" id="member-form" style="display:inline">                     Subscribe for Official newsletter
...
<script type="text/javascript" src="https://code.jquery.com/jquery-migrate-1.2.1.min.js"></script>
    ...
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDRiDrm36Kcz2OWvZgnwFAB1-Lk9SIQOlY&callback=initMap">
	   ...
	   <script>
      function initMap() {
        var uluru = {lat:22.560073 , lng: 88.413125};
